        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Subastas_Estado", "[Estado] IN ('PROGRAMADA', 'ACTIVA', 'FINALIZADA', 'DESIERTA')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransaccionLedger", x => x.Id);
                    table.CheckConstraint("CK_TransaccionLedger_Tipo", "[Tipo] IN ('DEPOSITO', 'RETENCION', 'LIBERACION', 'PAGO', 'COBRO')");
                    table.ForeignKey(
                        name: "FK_TransaccionLedger_Billeteras_BilleteraId",
                        column: x => x.BilleteraId,
                        principalTable: "Billeteras",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TransaccionLedger_Subastas_SubastaId",
                        column: x => x.SubastaId,
                        principalTable: "Subastas",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransaccionLedger_BilleteraId",
                table: "TransaccionLedger",
                column: "BilleteraId");

            migrationBuilder.CreateIndex(
                name: "IX_TransaccionLedger_SubastaId",
                table: "TransaccionLedger",
                column: "SubastaId");
        }
